...
async def send_cat_photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    cat_photo_id = "AgACAgIAAxkBAAEGdQ5pQ9VuPd0Ha2ItF3JBMddhivV7VwAC6AtrGzDSIEqlKKOuauDEwAEAAwIAA3gAAzYE"
...
async def send_sticker(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    sticker_file_id = "CAACAgIAAxkBAAEQB6lpQ9TLDNf02W64r2jsLIinUhm-BwACCRMAAm-pWEndpgiNyfvSBTYE"
...
async def send_evaluation_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    evaluation_text = "Васильев Роман и Елькин Артем"
...
async def handle_media(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        f"Спасибо, {user_name}! Фото-видео сохранено"
    )
